...
import { potentialCusomer } from '@/lib/data'
    ...
    <div className='w-full mx-auto h-full '>
      ...
      '>
        <div className='space-y-6'>
          <h2 className='text-primary font-semibold text-4xl'>
              Get maximus Conversion from your webinars
          </h2>
          <OnBoarding/>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 gap-6 place-content-center'>
          ...
          />
          <FeatureCard
          Icon = {<WebcamIcon className='w-10 h-10'/>}
          heading = "Browse or drag a pre-recorded webinar file"
          link = '/webinars'
          />
      ...
      rounded-xl bg-background-10'>
        ...
        <FeatureSectionLayout
          ...
          link='/pipeline'
        >
          <div className='flex gap-4 items-center h-full w-full justify-center
          relative flex-wrap
          '>
            {potentialCusomer.slice(0,2).map((customer, index)=>(
              <UserInfoCard
              customer={customer}
              tags = {customer.tags}
              key = {index}
